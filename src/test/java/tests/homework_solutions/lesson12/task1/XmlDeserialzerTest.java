...
public class XmlDeserialzerTest {
    private final XmlHelper helper = new XmlHelper();
    private final String ROOM_PATH = "src\\main\\java\\homework_task\\lesson12\\task1\\room.xml";
    private final String FLAT_PATH = "src\\main\\java\\homework_task\\lesson12\\task1\\flat.xml";
    private final String HOUSE_PATH = "src\\main\\java\\homework_task\\lesson12\\task1\\house.xml";
